		...
		<div className="px-[100px]">
			...
			<section>
				...
				<div className="max-w-2xl mx-auto border-2 border-amber-600 rounded-lg overflow-hidden shadow-lg">
					...
					<div className="px-4 py-3 bg-amber-50 border-b border-amber-300">
						<p className="text-sm text-gray-800 italic">
							Heavy, two-handed weapons with a bladed head, delivering powerful,
							sweeping strikes and capable of cleaving through armor.
						</p>
					</div>
					...
					<div className="divide-y divide-amber-300">
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									...
									1d12 Slice + 1d6 Blunt damage, Melee, Durability 5, Slot 6,
									Two-Handed
								</div>
							</div>
						</div>
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-amber-800">Properties</span>:
									2d10 Slice + 1d10 Blunt damage, Melee, Durability 8, Slot 8,
									Two-Handed, Heavy
								</div>
							</div>
						</div>
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-amber-800">Properties</span>:
									1d6 Slice + 1d6 Blunt damage, Melee, Thrown 15m, Durability 3,
									Slot 2, One-Handed, Light
								</div>
							</div>
						</div>
						{/* Longaxe */}
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-amber-800">Properties</span>:
									1d10 Slice + 1d6 Blunt damage, Melee, Durability 5, Slot 5,
									Versatile
								</div>
							</div>
						</div>
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-amber-800">Properties</span>:
									1d12 Pierce + 1d6 Blunt damage, Melee 2m, Durability 6, Slot
									6, Two-Handed
								</div>
							</div>
						</div>
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-amber-800">Properties</span>:
									2d8 Slice + 1d6 Blunt damage, Melee 2m, Durability 8, Slot 8,
									Two-Handed, Heavy
								</div>
							</div>
						</div>
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-amber-800">Properties</span>:
									1d12 Slice + 1d6 Blunt damage, Melee, Durability 5, Slot 4,
									Versatile
								</div>
							</div>
						</div>
					...
					<div className="divide-y divide-amber-300">
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-amber-800">Properties</span>:
									3d4 Blunt + 1d6 Pierce damage, Melee, Durability 5, Slot 4,
									Versatile
								</div>
							</div>
						</div>
					...
					<div className="divide-y divide-amber-300">
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-amber-800">Properties</span>:
									2d8 Pierce or Slice damage, Melee 3m, Durability 3, Slot 2,
									One-Handed, Precise, Risky
								</div>
							</div>
						</div>
					</div>
				...
				<div className="max-w-2xl mx-auto border-2 border-purple-600 rounded-lg overflow-hidden shadow-lg">
					...
					<div className="divide-y divide-purple-300">
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-purple-800">Properties</span>:
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-purple-800">Properties</span>:
									1d10 Slice or Pierce damage, Melee, Thrown 20m, Durability 3,
									Slot 2, One-Handed, Light, Sneak, Precise, Returning, Compact
									3
								</div>
							</div>
						</div>
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-purple-800">Properties</span>:
									1d10 Slice or Pierce damage, Melee, Thrown 10m, Durability 2,
									Slot 2, One-Handed, Light, Sneak, Precise
								</div>
							</div>
						</div>
						{/* Karambit */}
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-purple-800">Properties</span>:
									1d6 Pierce damage, Melee, Thrown 10m, Durability 3, Slot 1,
									One-Handed, Light, Sneak, Precise, Compact 6, Burst 3
								</div>
							</div>
						</div>
						{/* Kusarigama */}
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-purple-800">Properties</span>:
									1d12 Slice, Blunt, or Pierce damage, Melee 3m, Durability 3,
									Slot 2, Two-Handed, Light, Sneak, Precise, Risky
								</div>
							</div>
						</div>
						{/* Sai */}
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-purple-800">Properties</span>:
									1d10 Pierce damage, Melee, Durability 3, Slot 2, One-Handed,
									Defensive, Light, Sneak, Precise
								</div>
							</div>
						</div>
						{/* Secret Knife */}
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-purple-800">Properties</span>:
									1d4 Pierce damage, Melee, Thrown 10m, Durability 3, Slot 1,
									One-Handed, Light, Sneak, Precise, Compact 12, Burst 5
								</div>
							</div>
						</div>
					</div>
				...
				<div className="max-w-2xl mx-auto border-2 border-green-600 rounded-lg overflow-hidden shadow-lg">
					...
					<div className="px-4 py-3 bg-green-50 border-b border-green-300">
						<p className="text-sm text-gray-800 italic">
							Long-reaching weapons with various heads, offering versatility in
							both offensive and defensive combat strategies.
						</p>
					</div>
					...
					<div className="divide-y divide-green-300">
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-green-800">Properties</span>:
									2d12 Slice or Pierce damage, Melee 2m, Durability 5, Slot 6,
									Two-Handed, Precise, Heavy, Brace
								</div>
							</div>
						</div>
						{/* Halberd */}
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-green-800">Properties</span>:
									3d8 Slice, Blunt, or Pierce damage, Melee 2m, Durability 8,
									Slot 8, Two-Handed, Heavy, Brace
								</div>
							</div>
						</div>
						{/* Glaive */}
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-green-800">Properties</span>:
									3d6 Slice or Pierce damage, Melee 2m, Durability 5, Slot 8,
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-green-800">Properties</span>:
									3d8 Pierce damage, Melee 2m, Durability 8, Slot 8, Two-Handed,
									Heavy, Brace
								</div>
							</div>
						</div>
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-green-800">Properties</span>:
									2d10 Pierce damage, Melee, Thrown 25m, Durability 3, Slot 4,
									Versatile, Brace
								</div>
							</div>
						</div>
			...
			<section>
				...
				<div className="max-w-2xl mx-auto border-2 border-emerald-600 rounded-lg overflow-hidden shadow-lg">
					...
					<div className="px-4 py-3 bg-emerald-50 border-b border-emerald-300">
						<p className="text-sm text-gray-800 italic">
							Versatile ranged weapons with varying draw strengths, allowing for
							precise and sneak attacks.
						</p>
					</div>
				...
				<div className="max-w-2xl mx-auto border-2 border-indigo-600 rounded-lg overflow-hidden shadow-lg">
					...
					<div className="divide-y divide-indigo-300">
						...
						<div className="flex">
							...
							<div className="w-24 px-3 py-3 bg-indigo-100 border-r border-indigo-300 text-center">
								<div className="text-xs text-indigo-800">Compound Crossbow</div>
							</div>
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-indigo-800">Properties</span>:
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-indigo-800">Properties</span>:
									1d10 (arrow) damage, Ammo 1, Reload 1, Awkward 10m, Range 20m,
									Durability 3, Slot 2, One-Handed, Light, Sneak
								</div>
							</div>
						</div>
						{/* Recurve Crossbow */}
						<div className="flex">
							...
							<div className="w-24 px-3 py-3 bg-indigo-100 border-r border-indigo-300 text-center">
								<div className="text-xs text-indigo-800">Recurve Crossbow</div>
							</div>
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-indigo-800">Properties</span>:
									2d8 (arrow) damage, Ammo 1, Reload 2, Awkward 15m, Range 75m,
									Durability 3, Slot 4, Versatile, Sneak
								</div>
							</div>
						</div>
						{/* Repeating Crossbow */}
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-indigo-800">Properties</span>:
									1d8 (arrow) damage, Ammo 6, Reload 5, Awkward 15m, Range 40m,
									Durability 3, Slot 5, Versatile, Burst 6, Malfunction 2
								</div>
							</div>
						</div>
						{/* Wrist Crossbow */}
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-indigo-800">Properties</span>:
									1d10 (arrow) damage, Ammo 4, Reload 2, Awkward 5m, Range 20m,
									Durability 3, Slot 2, Attached, Light, Sneak, Malfunction 2
								</div>
							</div>
						</div>
					</div>
				...
				<div className="max-w-2xl mx-auto border-2 border-orange-600 rounded-lg overflow-hidden shadow-lg">
					...
					<div className="divide-y divide-orange-300">
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-orange-800">Properties</span>:
									1d12 (arrows) damage, Ammo 1, Reload 1, Awkward 5m, Range 15m,
									Durability 2, Slot 1, Two-Handed, Light, Sneak
								</div>
							</div>
						</div>
						{/* Boomerang */}
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-orange-800">Properties</span>:
									3d4 Blunt or Slice damage, Ammo 1, Reload 1, Awkward 5m, Range
									15m, Durability 3, Slot 1, One-Handed, Light, Returning,
									Risky, Compact 5
								</div>
							</div>
						</div>
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-orange-800">Properties</span>:
									2d6 (bullets) damage, Ammo 1, Reload 1, Awkward 5m, Range 20m,
									Durability 2, Slot 1, Two-Handed, Light, Sneak, Special (can
									use Explosives as ammo)
								</div>
							</div>
						</div>
					</div>
				...
				<div className="max-w-2xl mx-auto border-2 border-red-600 rounded-lg overflow-hidden shadow-lg">
					...
					<div className="px-4 py-3 bg-red-50 border-b border-red-300">
						<p className="text-sm text-gray-800 italic">
							Compact and easily wielded firearms with moderate damage, suitable
							for quick and agile combat scenarios.
						</p>
					</div>
					...
					<div className="divide-y divide-red-300">
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									...
									4d4 (bullets) damage, Ammo 1, Reload 3, Awkward 3m, Range 20m,
									Durability 3, Slot 2, Versatile, Loud, Malfunction 3
								</div>
							</div>
						</div>
						{/* Handcannon */}
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-red-800">Properties</span>:
									6d4 (bullets) damage, Ammo 6, Reload 5, Awkward 3m, Range 25m,
									Durability 5, Slot 3, Versatile, Loud, Malfunction 3
								</div>
							</div>
						</div>
						{/* Machine Pistol */}
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-red-800">Properties</span>:
									2d4 (bullets) damage, Ammo 4, Reload 2, Awkward 3m, Range 15m,
									Durability 3, Slot 1, One-Handed, Light, Sneak, Malfunction 2
								</div>
							</div>
						</div>
						{/* Revolver */}
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-red-800">Properties</span>:
									4d4 (bullets) damage, Ammo 6, Reload 5, Awkward 3m, Range 20m,
									Durability 3, Slot 2, Versatile, Loud, Malfunction 3
								</div>
							</div>
						</div>
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-red-800">Properties</span>:
									3d4 (bullets) damage, Ammo 8, Reload 3, Awkward 3m, Range 20m,
									Durability 3, Slot 2, Versatile, Loud, Sneak, Malfunction 2
								</div>
							</div>
						</div>
					</div>
					...
					<div className="divide-y divide-slate-300">
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									...
									1d4 (bullets) damage, Ammo 20, Reload 5, Awkward 15m, Range
									50m, Durability 5, Slot 4, Two-Handed, Loud, Burst 5,
									Malfunction 2
								</div>
							</div>
						</div>
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-slate-800">Properties</span>:
									3d10 (bullets) damage, Ammo 1, Reload 3, Awkward 15m, Range
									50m, Durability 3, Slot 4, Two-Handed, Loud, Malfunction 3
								</div>
							</div>
						</div>
						{/* Hunting Rifle */}
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									...
									100m, Snipe 400m, Durability 3, Slot 4, Two-Handed, Accurate,
									Loud, Sneak, Malfunction 3
								</div>
							</div>
						</div>
						{/* Machine Rifle */}
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-slate-800">Properties</span>:
									1d4-1 (bullets) damage, Ammo 30, Reload 5, Awkward 15m, Range
									50m, Durability 5, Slot 6, Two-Handed, Loud, Burst 10,
									Malfunction 3
								</div>
							</div>
						</div>
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									...
									100m, Snipe 600m, Durability 5, Slot 4, Two-Handed, Accurate,
									Loud, Malfunction 2
								</div>
							</div>
						</div>
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-slate-800">Properties</span>:
									3d10 (bullets) damage, Ammo 6, Reload 3, Awkward 25m, Range
									150m, Snipe 1200m, Durability 5, Slot 6, Two-Handed, Accurate,
									Sneak, Malfunction 2
								</div>
							</div>
						</div>
				...
				<div className="max-w-2xl mx-auto border-2 border-yellow-600 rounded-lg overflow-hidden shadow-lg">
					...
					<div className="px-4 py-3 bg-yellow-50 border-b border-yellow-300">
						<p className="text-sm text-gray-800 italic">
							Short-ranged firearms delivering powerful, spread-out shots, ideal
					...
					<div className="divide-y divide-yellow-300">
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-yellow-800">Properties</span>:
									1d6 (shells) damage, Ammo 15, Reload 5, Awkward 2m, Range 10m,
									Durability 5, Slot 4, Two-Handed, Loud, Burst 3, Malfunction 2
								</div>
							</div>
						</div>
						{/* Blunderbuss */}
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-yellow-800">Properties</span>:
									4d6 (shells) damage, Ammo 1, Reload 3, Awkward 2m, Range 10m,
									Durability 3, Slot 4, Two-Handed, Loud, Malfunction 3
								</div>
							</div>
						</div>
						{/* Boomstick */}
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-yellow-800">Properties</span>:
									1d6 (shells) damage, Ammo 2, Reload 3, Awkward 2m, Range 10m,
									Durability 3, Slot 2, One-Handed, Loud, Burst 2, Malfunction 3
								</div>
							</div>
						</div>
						{/* Combat Shotgun */}
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-yellow-800">Properties</span>:
									4d6 (shells) damage, Ammo 6, Reload 5, Awkward 2m, Range 10m,
									Durability 5, Slot 4, Two-Handed, Loud, Malfunction 3
								</div>
							</div>
						</div>
						{/* Hunting Shotgun */}
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-yellow-800">Properties</span>:
									1d10 (shells) damage, Ammo 2, Reload 3, Awkward 2m, Range 20m,
									Durability 3, Slot 4, Two-Handed, Loud, Burst 2, Malfunction 3
								</div>
							</div>
						</div>
						{/* Scattergun */}
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-yellow-800">Properties</span>:
									3d6 (shells) damage, Ammo 5, Reload 5, Awkward 2m, Range 10m,
									Durability 3, Slot 4, Two-Handed, Loud, Malfunction 3
								</div>
							</div>
						</div>
						...
						<div className="flex">
							...
							<div className="w-24 px-3 py-3 bg-yellow-100 border-r border-yellow-300 text-center">
								<div className="text-xs text-yellow-800">Tactical Shotgun</div>
							</div>
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-yellow-800">Properties</span>:
									3d6 (shells) damage, Ammo 6, Reload 5, Awkward 2m, Range 15m,
									Durability 5, Slot 4, Two-Handed, Sneak, Malfunction 2
								</div>
							</div>
						</div>
					</div>
				...
				<div className="max-w-2xl mx-auto border-2 border-emerald-600 rounded-lg overflow-hidden shadow-lg">
					...
					<div className="px-4 py-3 bg-emerald-50 border-b border-emerald-300">
						<p className="text-sm text-gray-800 italic">
							...
							damage, perfect for disrupting groups or flushing out enemies from
							cover.
						</p>
					</div>
					...
					<div className="divide-y divide-emerald-300">
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-emerald-800">Properties</span>
									: 5d4 Corrosion Damage and Inflicts Weakened at the end of the
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									...
									10m, Area 5 sqm, Durability 2, Slot 1, Disposable, One-Handed,
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									...
									(Any creature that starts its Turn in, enters, or moves within
									the area takes 5d4 Burn damage); Thrown 10m, Area 5 sqm,
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-emerald-800">Properties</span>
									: 5d4 Frost damage and Inflicts Slowed at the end of the next
									Turn, Thrown 10m, Area 5 sqm, Durability 2, Slot 1,
									Disposable, One-Handed, Compact 3, Blast, Explosive, Loud
								</div>
							</div>
						</div>
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-emerald-800">Properties</span>
									: At the end of the next Turn, Area is obscured for 2d4 Turns
									(Any creature within the area gains Greater Cover but is also
									considered Blinded while inside the area); Thrown 10m, Area 5
									sqm, Durability 2, Slot 1, Disposable, One-Handed, Compact 3,
									Blast
								</div>
							</div>
						</div>
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-emerald-800">Properties</span>
									: At the end of the next Turn, Area is stenched for 2d4 Turns
									(Any creature that starts its Turn in, enters, or moves within
									the area are Dazed and Dizzied); Thrown 10m, Area 5 sqm,
									Durability 2, Slot 1, Disposable, One-Handed, Compact 3,
									Blast, Loud
								</div>
							</div>
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									...
									Restrained and Immobilised; Thrown 10m, Area 5 sqm, Durability
					...
					<div className="divide-y divide-emerald-300">
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-emerald-800">Properties</span>
									: Instant 2d4 Pierce damage and Slowed, Trap (Proximity), Area
									3 sqm, Durability 2, Slot 1, Disposable, One-Handed, Light,
									Compact 5
								</div>
							</div>
						</div>
						...
						<div className="flex">
							...
							<div className="w-24 px-3 py-3 bg-emerald-100 border-r border-emerald-300 text-center">
								<div className="text-xs text-emerald-800">Sticky Substance</div>
							</div>
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-emerald-800">Properties</span>
									: Instant Immobilised, Trap (Proximity), Area 3 sqm,
									Durability 2, Slot 1, Disposable, One-Handed, Light, Compact 5
								</div>
							</div>
						</div>
						...
						<div className="flex">
							...
							<div className="w-24 px-3 py-3 bg-emerald-100 border-r border-emerald-300 text-center">
								<div className="text-xs text-emerald-800">Perimeter Alarm</div>
							</div>
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-emerald-800">Properties</span>
									: Loud acoustic alarm when triggered, alerts all allies within
									100m, Trap (Tripwire), Area 10m line, Durability 2, Slot 1,
									Disposable, One-Handed, Compact 5
								</div>
							</div>
						</div>
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-emerald-800">Properties</span>
									: Blinking lights and sound to attract enemies, draws enemies
									toward the device location, Trap (Timer or Remote), Area 3 sqm
									attraction radius, Durability 2, Slot 1, Disposable,
									One-Handed, Compact 5
								</div>
							</div>
						</div>
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-emerald-800">Properties</span>
									: Instant Immobilized and Prone until they escape (Strength vs
									Risk 8), Trap (Proximity), Area 4 sqm, Durability 3, Slot 2,
									Disposable, Two-Handed, Compact 3
								</div>
							</div>
						</div>
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									...
									Stamina per Turn to attempt escape (Strength vs Risk 8), Trap
									(Pressure), Area 1 sqm, Durability 4, Slot 1, Disposable,
									One-Handed, Compact 2
								</div>
							</div>
						</div>
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-emerald-800">Properties</span>
									: Instant 5d6 Pierce damage and Prone, requires 10 minutes and
									tools to dig, Trap (Pressure), Area 2 sqm, Durability 2, Slot
									3, Disposable, Two-Handed, Compact 2
								</div>
							</div>
						</div>
					...
					<div className="divide-y divide-emerald-300">
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-emerald-800">Properties</span>
									: 6d12 (charges) damage, Ammo 1, Reload 4, Awkward 10m, Range
									150m, Durability 6, Slot 6, Two-Handed, Explosive, Loud,
									Malfunction 3
								</div>
							</div>
						</div>
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-emerald-800">Properties</span>
									: 2d10 (canisters) damage, Ammo 5, Reload 3, Awkward 3m, Range
									20m, Durability 5, Slot 5, Two-Handed, Loud, Malfunction 3
								</div>
							</div>
						</div>
						...
						<div className="flex">
							...
							<div className="w-24 px-3 py-3 bg-emerald-100 border-r border-emerald-300 text-center">
								<div className="text-xs text-emerald-800">Grenade Launcher</div>
							</div>
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-emerald-800">Properties</span>
									: [Grenade] damage, Ammo 10, Reload 5, Range 50m, Durability
									3, Slot 4, Two-Handed, Malfunction 3, Limit: Only grenades can
									be used as ammunition and can be pre-loaded during downtime
									(loaded grenades do not take Equipment Slots.) Special: If the
									grenade travels at least 10m, the explosion becomes
									instantaneous however the target has to roll Defense Die
									against your Attack Die.
								</div>
							</div>
						</div>
					</div>
			...
			<section>
				...
				<div className="max-w-2xl mx-auto border-2 border-indigo-600 rounded-lg overflow-hidden shadow-lg">
					...
					<div className="px-4 py-3 bg-indigo-50 border-b border-indigo-300">
						<p className="text-sm text-gray-800 italic">
							Arrows are finely crafted projectiles designed for use with bows,
							crossbows, and launchers, offering ranged precision and lethal
							impact.
						</p>
					</div>
				...
				<div className="space-y-6">
					...
					<div className="max-w-2xl mx-auto border-2 border-red-600 rounded-lg overflow-hidden shadow-lg">
						...
						<div className="px-4 py-3 bg-red-50 border-b border-red-300">
							<p className="text-sm text-gray-800 italic">
								...
								delivering a powerful and controlled burst to engage targets at
								a distance.
							</p>
						</div>
					...
					<div className="max-w-2xl mx-auto border-2 border-red-600 rounded-lg overflow-hidden shadow-lg">
						...
						<div className="px-4 py-3 bg-red-50 border-b border-red-300">
							<p className="text-sm text-gray-800 italic">
								Shells are munitions crafted for shotguns, providing a wide and
								destructive spread upon impact.
							</p>
						</div>
						...
						<div className="divide-y divide-red-300">
							...
							<div className="flex">
								...
								<div className="w-24 px-3 py-3 bg-red-100 border-r border-red-300 text-center">
									<div className="text-xs text-red-800">Flechette (10 pcs)</div>
								</div>
								<div className="flex-1 px-4 py-3">
									<div className="text-sm">
										<span className="font-bold text-red-800">Properties</span>:
										Slice damage, Durability 3, Slot 1, 15° spread at 5m, 20°
							...
							<div className="flex">
								...
								<div className="w-24 px-3 py-3 bg-red-100 border-r border-red-300 text-center">
									<div className="text-xs text-red-800">Buckshot (10 pcs)</div>
								</div>
								<div className="flex-1 px-4 py-3">
									<div className="text-sm">
										<span className="font-bold text-red-800">Properties</span>:
										Pierce damage, Durability 3, Slot 1, 15° spread at 5m, 20°
										spread at 10m, Compact 50
									</div>
								</div>
							</div>
							...
							<div className="flex">
								...
								<div className="w-24 px-3 py-3 bg-red-100 border-r border-red-300 text-center">
									<div className="text-xs text-red-800">Flameshot (10 pcs)</div>
								</div>
								<div className="flex-1 px-4 py-3">
									<div className="text-sm">
										<span className="font-bold text-red-800">Properties</span>:
							...
							<div className="flex">
								...
								<div className="flex-1 px-4 py-3">
									<div className="text-sm">
										<span className="font-bold text-red-800">Properties</span>:
										Brilliant damage, Durability 3, Slot 1, 15° spread at 5m,
					...
					<div className="max-w-2xl mx-auto border-2 border-red-600 rounded-lg overflow-hidden shadow-lg">
						...
						<div className="px-4 py-3 bg-red-50 border-b border-red-300">
							<p className="text-sm text-gray-800 italic">
								Specialized ammunition packed with explosive force, designed for
								cannons to deliver maximum destruction to targets and
								fortifications.
							</p>
						</div>
						...
						<div className="divide-y divide-red-300">
							...
							<div className="flex">
								...
								<div className="flex-1 px-4 py-3">
									<div className="text-sm">
										<span className="font-bold text-red-800">Properties</span>:
										Sonic-Brilliant damage, Durability 3, Slot 1, Area 3 sqm,
										Compact 5
									</div>
								</div>
							</div>
							...
							<div className="flex">
								...
								<div className="flex-1 px-4 py-3">
									<div className="text-sm">
										<span className="font-bold text-red-800">Properties</span>:
										Toxic-Corruption damage, Durability 3, Slot 1, Area 3 sqm,
										Compact 5
									</div>
								</div>
							</div>
							...
							<div className="flex">
								...
								<div className="flex-1 px-4 py-3">
									<div className="text-sm">
										<span className="font-bold text-red-800">Properties</span>:
										Shock-Pure damage, Durability 3, Slot 1, Area 3 sqm, Compact
										5
									</div>
								</div>
							</div>
						...
						<div className="divide-y divide-red-300">
							...
							<div className="flex">
								...
								<div className="flex-1 px-4 py-3">
									<div className="text-sm">
										<span className="font-bold text-red-800">Properties</span>:
										Frost damage, Durability 3, Slot 1, 15° spread at 5m, 20°
										spread at 10m, Compact 25, Continuous, Lingering (Chilled)
									</div>
								</div>
							</div>
							{/* Electric Canister */}
							<div className="flex">
								...
								<div className="flex-1 px-4 py-3">
									<div className="text-sm">
										<span className="font-bold text-red-800">Properties</span>:
										Shock-Pure damage, Durability 3, Slot 1, 15° spread at 5m,
										20° spread at 10m, Compact 25, Continuous
									</div>
								</div>
							</div>
							{/* Toxic Canister */}
							<div className="flex">
								...
								<div className="flex-1 px-4 py-3">
									<div className="text-sm">
										<span className="font-bold text-red-800">Properties</span>:
										Toxic damage, Durability 3, Slot 1, 15° spread at 5m, 20°
										spread at 10m, Compact 25, Continuous, Lingering (Poisoned)
									</div>
								</div>
							</div>
							{/* Acid Canister */}
							<div className="flex">
								...
								<div className="flex-1 px-4 py-3">
									<div className="text-sm">
										<span className="font-bold text-red-800">Properties</span>:
										Corrosion damage, Durability 3, Slot 1, 15° spread at 5m,
