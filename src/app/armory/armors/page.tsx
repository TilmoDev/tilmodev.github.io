					...
					<div className="max-w-2xl mx-auto border-2 border-amber-600 rounded-lg overflow-hidden shadow-lg">
						...
						<div className="px-4 py-3 bg-amber-50 border-b border-amber-300">
							<p className="text-sm text-gray-800 italic">
								Light Armors provide agile protection, allowing wearers to
								swiftly navigate the battlefield with minimal hindrance, making
								them ideal for nimble and evasive combat styles.
							</p>
						</div>
					...
					<div className="max-w-2xl mx-auto border-2 border-amber-600 rounded-lg overflow-hidden shadow-lg">
						...
						<div className="px-4 py-3 bg-amber-50 border-b border-amber-300">
							<p className="text-sm text-gray-800 italic">
								...
								wearers maximum protection at the cost of some mobility,
								ensuring they stand as unyielding bastions against the onslaught
								of adversaries.
							</p>
						</div>
					...
					<div className="max-w-2xl mx-auto border-2 border-amber-600 rounded-lg overflow-hidden shadow-lg">
						...
						<div className="px-4 py-3 bg-amber-50 border-b border-amber-300">
							<p className="text-sm text-gray-800 italic">
								...
								flexibility in movement, making them suitable for those who
								favor a balanced approach.
							</p>
						</div>
						...
						<div className="divide-y divide-amber-300">
							...
							<div className="flex">
								...
								<div className="flex-1 px-4 py-3">
									<div className="text-sm">
										<span className="font-bold text-amber-800">Properties</span>
										: Defense Dice 1d10, Durability 10, Slot 3, Bulk 0,
										One-Handed
									</div>
								</div>
							</div>
					...
					<div className="max-w-2xl mx-auto border-2 border-amber-600 rounded-lg overflow-hidden shadow-lg">
						...
						<div className="px-4 py-3 bg-amber-50 border-b border-amber-300">
							<p className="text-sm text-gray-800 italic">
								...
								protection, allowing wielders to weather even the most
								formidable attacks while sacrificing some agility in exchange
								for unyielding stability on the battlefield.
							</p>
						</div>
						...
						<div className="divide-y divide-amber-300">
							...
							<div className="flex">
								...
								<div className="flex-1 px-4 py-3">
									<div className="text-sm">
										<span className="font-bold text-amber-800">Properties</span>
										: Defense Dice 1d12, Durability 15, Slot 4, Bulk 1,
										One-Handed
									</div>
								</div>
							</div>
							...
							<div className="flex">
								...
								<div className="flex-1 px-4 py-3">
									<div className="text-sm">
										<span className="font-bold text-amber-800">Properties</span>
										: Defense Dice 1d12, Durability 20, Slot 5, Bulk 2,
										One-Handed
									</div>
								</div>
							</div>
