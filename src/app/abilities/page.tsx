		...
		<div className="flex flex-col">
			...
			<div className="mb-4">
				...
				<p className="text-gray-700">
					...
					indicating how adept you are at wielding weapons such as swords, bows,
					or guns. In game terms, proficiency simply increases your Base Dice
					permanently (from d6 to d8, and so on), enhancing your ability to hit
					your target when using a specific weapon or succeed on a stunt. They
					also come with a perk. Your character can acquire up to a maximum of
					five (5) Proficiencies at any time. You can purchase additional
					Proficiencies during character creation or at a later time.
				</p>
			</div>
			{/* Core Proficiences */}
			<section>
				...
				<div className="max-w-2xl mx-auto border-2 border-amber-600 rounded-lg overflow-hidden shadow-lg">
					...
					<div className="divide-y divide-amber-300">
						...
						<div className="flex bg-amber-25">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									Draw and Holster maneuvers are now free. The Stamina cost for
									the Administer and Hide maneuvers is reduced by 1.
						...
						<div className="flex bg-amber-25">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									...
									of -1. Additionally, when using the Defend maneuver, add +2 to
									Defense Dice per point of Stamina spent instead of +1.
								</div>
							</div>
						</div>
					</div>
						...
						<div className="flex bg-amber-25">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									...
									perform complex interactions (e.g., hacking, disarming traps)
									at no additional Stamina cost.
								</div>
							</div>
						</div>
					</div>
				...
				<div className="max-w-2xl mx-auto border-2 border-amber-600 rounded-lg overflow-hidden shadow-lg">
					...
					<div className="divide-y divide-amber-300">
						...
						<div className="flex bg-amber-25">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									The Stamina cost of the Concentrate maneuver is reduced by 1.
									Additionally, when using the Assess maneuver, roll two dice
									instead but choose the highest result.
								</div>
							</div>
						</div>
					</div>
				...
				<div className="max-w-2xl mx-auto border-2 border-amber-600 rounded-lg overflow-hidden shadow-lg">
					...
					<div className="px-4 py-3 bg-amber-50 border-b border-amber-300">
						<p className="text-sm text-gray-800 italic">
							...
							adversaries and seamlessly navigating through challenges with raw
							power.
						</p>
					</div>
						...
						<div className="flex bg-amber-25">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									...
									Additionally, you can move up to 7 meters per point of Stamina
									spent.
								</div>
							</div>
						</div>
				...
				<div className="max-w-2xl mx-auto border-2 border-amber-600 rounded-lg overflow-hidden shadow-lg">
					...
					<div className="px-4 py-3 bg-amber-50 border-b border-amber-300">
						<p className="text-sm text-gray-800">
							Combat is typically straightforward, with creatures making Attack
							Dices and defending creatures responding with Defense Dices.
							However, certain scenarios (especially outside of combat) arise
							that the rules may not explicitly cover, such as breaking a door
							or resisting the effects of cold or poison, or even avoiding or
							stopping a falling chandelier. In such instances, Core
							Proficiencies come into play, providing room for creativity and
							collaboration between you and the Director.
						</p>
					</div>
				</div>
			</section>
				...
				<div className="max-w-2xl mx-auto border-2 border-amber-600 rounded-lg overflow-hidden shadow-lg">
					...
					<div className="px-4 py-3 bg-amber-50 border-b border-amber-300">
						<p className="text-sm text-gray-800 italic">
							...
							nimble finesse, enhancing your defense as you seamlessly navigate
							through combat.
						</p>
					</div>
				...
				<div className="max-w-2xl mx-auto border-2 border-amber-600 rounded-lg overflow-hidden shadow-lg">
					...
					<div className="divide-y divide-amber-300">
						...
						<div className="flex bg-amber-25">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									The effect of Slice damage no longer applies while you&apos;re
									wearing Light Armor.
								</div>
							</div>
						</div>
				...
				<div className="max-w-2xl mx-auto border-2 border-amber-600 rounded-lg overflow-hidden shadow-lg">
					...
					<div className="divide-y divide-amber-300">
						...
						<div className="flex bg-amber-25">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									The effect of Blunt damage no longer applies while you&apos;re
									wearing Heavy Armor.
								</div>
							</div>
						</div>
			...
			<section>
				...
				<div className="max-w-2xl mx-auto border-2 border-amber-600 rounded-lg overflow-hidden shadow-lg">
					...
					<div className="divide-y divide-amber-300">
						...
						<div className="flex bg-amber-25">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									If your attack deals at least 10 damage, the target is Dazed.
								</div>
							</div>
						</div>
					</div>
				...
				<div className="max-w-2xl mx-auto border-2 border-amber-600 rounded-lg overflow-hidden shadow-lg">
					...
					<div className="px-4 py-3 bg-amber-50 border-b border-amber-300">
						<p className="text-sm text-gray-800 italic">
							A master of daggers, you move like a shadow, swiftly and lethally
							striking at vulnerable points, making each confrontation a deadly
							dance.
						</p>
					</div>
				...
				<div className="max-w-2xl mx-auto border-2 border-amber-600 rounded-lg overflow-hidden shadow-lg">
					...
					<div className="divide-y divide-amber-300">
						...
						<div className="flex bg-amber-25">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									If you did not move on your last Turn, roll twice on your next
									Attack Dice and take the highest result.
								</div>
							</div>
						</div>
					</div>
				...
				<div className="max-w-2xl mx-auto border-2 border-amber-600 rounded-lg overflow-hidden shadow-lg">
					...
					<div className="px-4 py-3 bg-amber-50 border-b border-amber-300">
						<p className="text-sm text-gray-800 italic">
							...
							delivering devastating blasts that leave your enemies in disarray.
						</p>
					</div>
					...
					<div className="divide-y divide-amber-300">
						...
						<div className="flex bg-amber-25">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									On a successful hit, you can push the target 1m directly away
									from you if your damage is at least 5 (cumulative).
								</div>
							</div>
						</div>
					</div>
				...
				<div className="max-w-2xl mx-auto border-2 border-amber-600 rounded-lg overflow-hidden shadow-lg">
					...
					<div className="px-4 py-3 bg-amber-50 border-b border-amber-300">
						<p className="text-sm text-gray-800 italic">
							...
							potent brews and salves, enhancing their effects and never lacking
							vital remedies when they’re needed most.
						</p>
					</div>
					...
					<div className="divide-y divide-amber-300">
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-amber-800">Rank I</span> -
									Your maximum Compact size for this equipment type increases to
									6.
								</div>
							</div>
						</div>
				...
				<div className="max-w-2xl mx-auto border-2 border-amber-600 rounded-lg overflow-hidden shadow-lg">
					...
					<div className="px-4 py-3 bg-amber-50 border-b border-amber-300">
						<p className="text-sm text-gray-800 italic">
							...
							making them harder to spot and ensuring unwary foes stumble right
					...
					<div className="divide-y divide-amber-300">
						...
						<div className="flex">
							...
							<div className="flex-1 px-4 py-3">
								<div className="text-sm">
									<span className="font-bold text-amber-800">Rank I</span> - The
									Risk Threshold to detect or disarm your snares increases by 1.
								</div>
							</div>
						</div>
